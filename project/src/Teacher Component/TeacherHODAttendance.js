...
export const TeacherHODAttendance = () => {
    ...
    const [sem, setSem] = useState('BE-SEM8-C-COMP');
        ...
        <div>
            ...
            <div className="container" style={{ display: "block" }}>
                ...
                <select className="form-select my-3" name="semister" id="" onChange={(e) => { setSem(e.target.value) }}>
                    <option value="BE-SEM8-C-COMP">BE-SEM8-C-COMP</option>
                    <option value="TE-SEM6-C-COMP">TE-SEM6-C-COMP</option>
                    <option value="SE-SEM4-C-COMP">SE-SEM4-C-COMP</option>
                </select>
